...
public class MenuNagusia extends JFrame
{
	...
	public MenuNagusia()
	{
		setTitle("Kudeatzaile Nagusia GidariLehioa");
		...
		edukiontzia = new JPanel(new GridBagLayout())
		{
			...
			protected void paintComponent(Graphics g)
			{
				...
				Color			kolorea1	= new Color(86, 171, 228);												// goiko
																													// kolorea
				Color			kolorea2	= new Color(238, 245, 249);												// beheko
																													// kolorea
		...
		JButton		btn1			= sortuBotoiLeuna(
				"Gidariak", letra, botoiNeurriak, urdinNormala, urdinHover, urdinKlik
		);
		...
		// 2. botoia — erabiltzaileentzako
		JButton btn3 = sortuBotoiLeuna("Bidaiak", letra, botoiNeurriak, urdinNormala, urdinHover, urdinKlik);
		botoiPanela.add(btn3);
		// Gehitu botoien panela edukiontzira
		edukiontzia.add(botoiPanela);
	}

	// Botoiak efektu leunarekin sortzeko metodoa
	private JButton sortuBotoiLeuna(String testua, Font letra, Dimension neurriak, Color normala, Color hover,
			Color klikatuta)
	{
